...
public class hmm1 {
   public static void main(String[] args) {
      ...
      alpha = Matrix.computeAlphaMatrix(A, B, pi, sequence);

      System.out.println(alpha.findTotalEmissionSeqProbability());
      //System.out.println(String.format("%.6f", alpha.findLastMax()));
